...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.inputDataFrame.setStyleSheet("border: 2px solid #8f8f91; background: ")
        ...
        self.gridLayout.addWidget(self.inputDataFrame, 2, 0, 2, 2)
        ...
        self.outputParamsDataFrame.setStyleSheet("border: 2px solid #8f8f91;")
        ...
        self.gridLayout.addWidget(self.outputParamsDataFrame, 5, 0, 1, 2)
        self.btnCalcTPut = QtWidgets.QPushButton(self.centralwidget)
        self.btnCalcTPut.setEnabled(True)
        self.btnCalcTPut.setStyleSheet("QPushButton {\n"
...
"  }")
        ...
        self.gridLayout.addWidget(self.btnCalcTPut, 8, 0, 1, 2)
        ...
        font.setBold(True)
        font.setWeight(75)
        self.outputTabela.setFont(font)
        self.outputTabela.setStyleSheet("border: 2px solid #8f8f91; padding: 2px 2px;")
        self.outputTabela.setAlignment(QtCore.Qt.AlignCenter)
        self.outputTabela.setObjectName("outputTabela")
        self.gridLayout.addWidget(self.outputTabela, 11, 0, 1, 2)
        ...
        font.setBold(True)
        font.setWeight(75)
        self.outputEquacao.setFont(font)
        self.outputEquacao.setStyleSheet("border: 2px solid #8f8f91; padding: 2px 2px;")
        self.outputEquacao.setText("")
        self.outputEquacao.setAlignment(QtCore.Qt.AlignCenter)
        self.outputEquacao.setObjectName("outputEquacao")
        self.gridLayout.addWidget(self.outputEquacao, 16, 0, 1, 2)
